...
class AdminUserInformation(admin.ModelAdmin):
    ...
    list_display = ('user', 'first_name', 'last_name', 'country', 'is_active', 'created_at')
    fieldsets = (
        ('User',
         {'fields': ('user',)}),
        ('User Information',
         {'fields': (
             'first_name', 'last_name', 'gender', 'profile_pic', 'birth_date',
         )}),
        ('Contact Information',
         {'fields': (
             'address_one', 'address_two', 'city', 'zipcode',
